...
class ProductDetailPage extends Component {
  ...
  purchaseProduct() {
    this.props.awsLogin.makeApiRequest(config.EventWriterApi, 'POST', '/event-writer/', {
      schema: 'pastrylabs/product/purchase/1-0-0',
      id: this.props.params.id,
      origin: `localstore/web-client-purchase-product/${this.props.awsLogin.state.profile.id}/${this.props.awsLogin.state.profile.name}`,
    })
      .then(() => {
