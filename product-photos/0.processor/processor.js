...
const transformer = (payload, record) => {
  ...
  result.schema = 'pastrylabs/retail-stream-egress/1-0-0'
...
const impl = {
   ...
   * {
   *   "schema": "pastrylabs/retail-stream/1-0-0",
   *   "origin": "localstore/photographer-registration-automation",
   *   "timeOrigin": "2017-01-12T18:29:25.171Z",
   *   "data": {
   *     "schema": "pastrylabs/user-info/update-phone/1-0-0",
   *     "id": "4579874",
   *     "phone": "1234567890"
   *   }
   * }
   ...
   * {
   *   "schema": "pastrylabs/retail-stream/1-0-0",
   *   "origin": "localstore/product-producer-automation",
   *   "timeOrigin": "2017-01-12T18:29:25.171Z",
   *   "data": {
